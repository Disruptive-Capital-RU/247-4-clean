        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16">
            ...
            <p className="font-dm-sans text-lg text-white/80 max-w-3xl mx-auto">
              {t("whyChooseReluxiDesc") || "Reluxi is more than a concierge — it&apos;s your trusted presence in a foreign city. With too many options, not enough time, and no one to filter the noise, we&apos;re here to guide, simplify, and support. Our mission is to remove the stress and friction of unfamiliar places, so every moment feels purposeful, cared for, and entirely your own."}
            </p>
          </div>
