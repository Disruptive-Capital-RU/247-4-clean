...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        "group/bento shadow-input row-span-1 flex flex-col justify-between space-y-3 rounded-xl border-[0.5px] border-[#D4AF37] bg-black p-3 transition duration-200 hover:shadow-xl",
        className,
      )}
    >
      {header}
